...
public class Main {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 4://Buscar Trabajador por Nombre
                    ...
                    break;
                case 5://Devuelve lista examen.Servicios de una clase(examen.TrabajoPintura o examen.RevisionAlarma)
                ...
                case 7://Eliminar servicio por Id
                    ...
                    break;
                case 8://Mostrar lista ordenada por fecha de inicio del servicio(orden natural)
                    g.ordenarServicios();;
                    break;
    ...
    private Servicios insertarNuevoServicio() {
        ...
        System.out.println("Nuevo Servicio\n" +
                "Tipo de Servicio (examen.RevisionAlarma, examen.TrabajoPintura):");
        ...
        cliente = sc.nextLine();
        System.out.println("El servicio es examen.RevisionAlarma S/N?");
    ...
    private void showMenu() {
        ...
        System.out.println("-----MENU-----\n" +
                ...
                "3 Buscar examen.Servicios de un empleado\n" +
                "4 Buscar examen.Servicios de un cliente\n" +
                "5 Buscar examen.Servicios de un tipo\n" +
