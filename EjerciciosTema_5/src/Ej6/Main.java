    ...
    public static void main(String[] args) {
        ...
        for (Vehiculos v : listaVehiculos) {
            if (v != null) {
                ...
                //INSTANCEOF se usa para verificar si el objeto es una instancia de una clase particular
                //(en este caso, si el vehículo es de tipo Turismo o Furgoneta).
                if (v instanceof Turismo) {
                    System.out.println("Es un Turismo: " + v);  // Llamamos a toString() de Turismo
                } else if (v instanceof Furgoneta) {
                    System.out.println("Es una Furgoneta: " + v);  // Llamamos a toString() de Furgoneta
                }
            } else {
